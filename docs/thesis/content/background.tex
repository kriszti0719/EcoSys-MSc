...
\begin{itemize}
    ...
    \item \textbf{Fuzzy Cognitive Map (FCM):} A legkomplexebb alkalmazott módszer, amelyben a döntéshozatalt egy irányított, súlyozott gráf reprezentálja. Itt a belső állapotok és fogalmak egymásra gyakorolt hatása révén apró változások is finom, nem-lineáris viselkedésformákat eredményezhetnek. A rendszer tervezésekor külön figyelmet fordítottam ezen komplex gráfszerkezet hatékony tárolására és az eseményvezérelt architektúrába való integrálására. Az FCM elméleti működését és a komplex, közvetett kauzális összefüggések kezelését egy klasszikus környezetgazdaságtani példán keresztül a \ref{fig:fcm_theoretical_example}. ábra szemlélteti.
\end{itemize}

\begin{figure}[h!]
\centering
\includegraphics[width=0.7\textwidth]{figures/fcm_eg.png}
\caption{Klasszikus Fuzzy Kognitív Térkép elméleti példája: közvetlen és közvetett kauzális kapcsolatok rendszere \cite{Uni26}}
\label{fig:fcm_theoretical_example}
\end{figure}

A fenti modellben jól megfigyelhető, hogy az egyes koncepciók nemcsak közvetlenül, hanem közvetett kauzális láncokon keresztül is befolyásolják egymást. Például a mocsaras élőhelyek (\textit{Wetlands}) védelme egyaránt növeli a turizmust és a vízminőség javításán keresztül a halállományt (\textit{Fish}), amelyek végül egymást erősítve, kumulatív módon fejtik ki pozitív hatásukat a teljes gazdasági bevételre (\textit{Income}).
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth]{figures/SL_19.png}
    \caption{Sebastian Lague - Ecosystem projektje}
    \label{fig:sl}
\end{figure}

\subsection{VAV: Evolúciós devlog}

VAV fejlesztése \cite{VAV23} Lague alapjaira építve mutat be egy továbbfejlesztett modellt. Ebben a megoldásban kiemelkedő a morfológiai jellemzők öröklődése és környezethez való adaptációja  (például az állatok nyakhosszának öröklődése, igazodva a fák magasságához, ahogy az a \ref{fig:vav} ábrán is jól látható) . 
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth]{figures/VAV_23.png}
    \caption{VAV - Evolúciós megoldása}
    \label{fig:vav}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth]{figures/Fun_22.png}
    \caption{Fun Master Ed - Szabadon testreszabható állatai}
    \label{fig:fun}
\end{figure}
