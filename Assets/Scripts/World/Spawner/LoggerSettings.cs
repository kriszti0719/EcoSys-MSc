...
public class LoggerSettings : Spawner
{
    [Header("Fox")]
    ...
    // 60 frame = 1 másodperc, HA 60 FPS
    public int frameCounter = 0;
    public int framesPerChange = 6*10; 
    ...
    protected virtual void Start()
    {
        ...
        DebugLogger.RegisterPopulation(step, counterBunny: amount, counterFox: amount2);
    }
    protected virtual void Update()
    {
        ...
        {
            DebugLogger.RegisterPopulation(step, counterBunny: Counter("BUNNY"), counterFox: Counter("FOX"));
            frameCounter = 0;
        }
    }
